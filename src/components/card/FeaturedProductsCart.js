...
const FeaturedProductsCart = () => {
    return (
        <div className="w-[220px] sm:w-[250px] relative bg-[#fff]  rounded-md hover:shadow-inner shadow-md m-2">
            ...
            <Link href={"/product/id"} className="mt-3" style={{ borderBottom: "3px solid rgba(55,73,187,.03)" }}>
            ...
            <div className="px-5 py-2">
                <Link href={"/product/id"} className="font-serif  text-[#111] hover:text-[#ef4a23]  text-[17px] hover:underline cursor-pointer">ACER EK220Q H3bi 21.5 inch 1ms 100hz Borderless Full HD Monitor</Link>
