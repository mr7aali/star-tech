            ...
            <div className='max-w-[400px] mx-auto mt-16 mb-24'>
                ...
                <Forms submitHandler={onSubmit} >
                    <div>
                        ...
                        // className='block rounded-md px-5 w-full font-serif py-2 outline-none focus:border-[#5252ff] border-[#ddd] border-[1px] rounded-' type="text" placeholder='Phone / E-Mail'
                        />
                    </div>
                    <div>
